...
compound InChIkey(s) and downloads the corresponding compounds from PubChem
Power User Gateway (PUG) returning results in list of two items. The list item is 
